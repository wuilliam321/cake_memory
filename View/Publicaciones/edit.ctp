		...
		<fieldset>
			...
			<div class="row-fluid">
				<div class="span6">
					...
					<?php echo $this->Html->link(__('Add Autore'), array('controller' => 'autores', 'action' => 'add', $this->request->data['Publicacione']['id']), array('class' => 'btn btn-primary btn-small')); ?>
				</div>
				<div class="span6">
			...
			<?php foreach ($this->request->data['Recursomultimedia'] as $recursomultimedia): ?>
				...
				<div class="span6 well">
					...
					<div class="row-fluid">
						<?php echo $this->Form->input('Recursomultimedia.'  . $i . '.recursomultimediatipo_id', array('class' => 'span12', 'div' => array('class' => 'span12'))); ?>
					</div>
					<div class="row-fluid">
						<?php echo $this->Form->input('Recursomultimedia.'  . $i . '.nombre', array('type' => 'text', 'class' => 'span12', 'div' => array('class' => 'span12'))); ?>
					</div>
					<div class="row-fluid">
						<?php echo $this->Form->input('Recursomultimedia.'  . $i . '.ruta', array('class' => 'span12', 'rows' => 2, 'div' => array('class' => 'span12'))); ?>
					</div>
					<div class="row-fluid">
						<?php echo $this->Form->input('Recursomultimedia.'  . $i . '.descripcion', array('class' => 'span12', 'rows' => 4, 'div' => array('class' => 'span12'))); ?>
					</div>
				</div>
