...
<?php echo $this->Form->create('Autore'); ?>
	<fieldset>
		<legend><?php echo __('Edit Autore'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Autore.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Autore.id'))); ?></li>
