	...
	<?php foreach($autores as $autore): ?>
		...
		<article class="is-post is-post-excerpt autore span5 offset1">
			<header>
				...
				<span class="byline"><?php echo $autore['Unidadinvestigacione']['nombre']; ?> - <?php echo $autore['Profesione']['nombre'];  //echo $this->Html->link($autore['Unidadinvestigacione']['nombre'], array('controller' => 'unidadinvestigaciones', 'action' => 'view', $autore['Unidadinvestigacione']['id'])); ?></span>
			</header>
			<div class="info">
				<ul class="stats">
