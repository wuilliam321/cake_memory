<div class="autores index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $autore['Autore']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $autore['Autore']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $autore['Autore']['id']), null, __('Are you sure you want to delete # %s?', $autore['Autore']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
