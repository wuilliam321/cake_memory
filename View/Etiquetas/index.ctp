<div class="etiquetas index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $etiqueta['Etiqueta']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $etiqueta['Etiqueta']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $etiqueta['Etiqueta']['id']), null, __('Are you sure you want to delete # %s?', $etiqueta['Etiqueta']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
