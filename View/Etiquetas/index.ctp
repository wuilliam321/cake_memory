<div id="content-inner" class="container etiquetas index is-post">
	<div class="top-menu">
		<ul>
		...
		<?php foreach ($etiquetas as $etiqueta): ?>
			<tr>
				...
				<td class="actions">
					...
					<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $etiqueta['Etiqueta']['id'])); ?>
					<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $etiqueta['Etiqueta']['id']), null, __('¿Está seguro(a) que desea eliminar este registro?')); ?>
				</td>
			</tr>
		<?php endforeach; ?>
	</table>
