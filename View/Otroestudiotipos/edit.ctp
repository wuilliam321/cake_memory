...
<?php echo $this->Form->create('Otroestudiotipo'); ?>
	<fieldset>
		<legend><?php echo __('Edit Otroestudiotipo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Otroestudiotipo.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Otroestudiotipo.id'))); ?></li>
