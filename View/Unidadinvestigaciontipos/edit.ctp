<div id="content-inner" class="unidadinvestigaciontipos form is-post">
	<div class="top-menu">
		<ul>
			...
			<li><?php echo $this->Html->link(__('Editar'), array('controller' => 'unidadinvestigaciontipos', 'action' => 'edit', $this->request->data['Unidadinvestigaciontipo']['id']), array('class' => 'active')); ?></li>
		</ul>
	</div>
	<?php echo $this->Form->create('Unidadinvestigaciontipo'); ?>
		<fieldset>
			<h2><?php echo __('Edit Unidadinvestigaciontipo'); ?></h2>
			<div class="row-fluid">
