<div id="content-inner" class="recursomultimediatipos form is-post">
	...
	<?php echo $this->Form->create('Recursomultimediatipo'); ?>
		...
		<div class="submit-block">
			...
			<?php echo $this->Html->link(__('Cancel'), array('controller' => 'recursomultimediatipos', 'action' => 'index'), array('class' => 'cancel-btn'), __('¿Está seguro(a) que desea cancelar la operación?')); ?>
		</div>
