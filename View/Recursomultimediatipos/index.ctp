<div id="content-inner" class="container recursomultimediatipos index is-post">
	<div class="top-menu">
		<ul>
			<li><?php echo $this->Html->link(__('Listado'), array('controller' => 'recursomultimediatipos', 'action' => 'index'), array('class' => 'active')); ?></li>
		...
		<?php foreach ($recursomultimediatipos as $recursomultimediatipo): ?>
			<tr>
				...
				<td class="actions">
					...
					<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $recursomultimediatipo['Recursomultimediatipo']['id'])); ?>
					<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $recursomultimediatipo['Recursomultimediatipo']['id']), null, __('¿Está seguro(a) que desea eliminar este registro?')); ?>
				</td>
			</tr>
		<?php endforeach; ?>
	</table>
