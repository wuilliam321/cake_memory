...
<?php echo $this->Form->create('Otroestudio'); ?>
	<fieldset>
		<legend><?php echo __('Edit Otroestudio'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Otroestudio.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Otroestudio.id'))); ?></li>
