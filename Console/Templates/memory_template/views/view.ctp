 ...
 */
?>
<div id="content-inner" class="container <?php echo $pluralVar; ?> view is-post">
	<div class="top-menu">
		<ul>
			...
			<li><?php echo "<?php echo \$this->Html->link(__('Editar'), array('controller' => '$pluralVar', 'action' => 'edit', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?>"; ?></li>
			<li><?php echo "<?php echo \$this->Html->link(__('Ver'), array('controller' => '$pluralVar', 'action' => 'view', \${$singularVar}['{$modelClass}']['{$primaryKey}']), array('class' => 'active')); ?>"; ?></li>
			<li><?php echo "<?php echo \$this->Form->postLink(__('Eliminar'), array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']), null, __('¿Está seguro(a) que desea eliminar este registro?')); ?>"; ?></li>
		</ul>
	</div>
...
<?php echo "\t<?php endif; ?>\n\n"; ?>
	<div class="actions">
		<ul>
			<li><?php echo "<?php echo \$this->Html->link(__('Agregar " . Inflector::humanize(Inflector::underscore($alias)) . "'), array('controller' => '{$details['controller']}', 'action' => 'add')); ?>"; ?> </li>
		</ul>
	</div>
</div>
<?php endforeach; ?>
